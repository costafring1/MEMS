...
filepath = '../test_empirical/thermoacoustic/data/resids/resids_thermo_forced_3.csv' #added _1! LEs faire tous!!

# Filepath to export ensemble DL predictions to
filepath_out = '../test_empirical/paleoclimate/data/ml_preds/model_diy/diy_thermo_forced_3_étalon.csv' #mettre dans un soddeir specifique et noms specifique!
...
def get_dl_predictions(resids, model_type, kk):
    ...
    model_name = 'best_models/best_model_étalon_{}_{}_length{}.keras'.format(kk,model_type,ts_len) #changed pkl to keras
