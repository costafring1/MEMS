...
## Attenion j'ai rajouté à chque chemin +- un training_data/
##
...
python3 ../../../training_data/gen_model.py #python3 ../../../gen_model.py

# Copy AUTO model and constants files to batch-specific directory
cp ../../../training_data/c.model c.model
cp ../../../training_data/model.f90 model.f90
...
timeout 600 echo "PassWord12" | sudo /home/costa_fring/MEMOIRE/auto-07p/bin/auto ../../../training_data/run_cont.auto
if [[ $? == 124 ]]
then
...
#echo "PassWord12" | sudo rm -f c.model
#echo "PassWord12" | sudo rm -f model.f90
...
python3 ../../../training_data/stoch_sims.py $hopf_count $fold_count $branch_count $null_h_count $null_f_count $null_b_count $bif_max $batch_num $ts_len
...
#echo "PassWord12" | sudo rm -r output_model
#echo "PassWord12" | sudo rm -r output_auto
...
python3 ../../../training_data/to_traindata.py $bif_max $batch_num

# Remove single label files
#echo "PassWord12" | sudo rm output_labels/label*

# Compute residual dynamics after Lowess smoothing for each time series
echo "Compute residuals"
python3 ../../../training_data/compute_resids.py $bif_max $batch_num
